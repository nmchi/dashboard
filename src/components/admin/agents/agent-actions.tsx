...
import { MoreHorizontal, Ban, Trash2, LockOpen, KeyRound } from "lucide-react";
import { toast } from "sonner";
import { toggleBanAgent, deleteAgent, resetAgentPassword } from "@/server/admin/agent-actions";
import {
    AlertDialog,
    AlertDialogAction,
    AlertDialogCancel,
